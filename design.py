...
class App(customtkinter.CTk):
    def __init__(self) -> None:
        ...
        self.sidebar_button_2 = customtkinter.CTkButton(self.sidebarFrame, text="Screenshot Viewer", command=self.switchLayoutScreenshot)
        ...
        self.ssFrame = screenshotFrame(self, ontakeScreenshot=self.switchLayoutScreenshot)
